...
public class SearchFrm extends JFrame {
	...
	public SearchFrm(ClientFrm frm) {
				...
				.addGroup(gl_panel.createSequentialGroup().addGap(6)
						.addGroup(gl_panel.createParallelGroup(Alignment.LEADING, false)
								.addGroup(gl_panel.createSequentialGroup().addComponent(label)
										...
										.addGap(40).addComponent(label_2).addPreferredGap(ComponentPlacement.RELATED)
								...
								.addGroup(gl_panel.createSequentialGroup().addComponent(label_1)
										.addPreferredGap(ComponentPlacement.UNRELATED)
										.addComponent(edPlaceTxt, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
												GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE,
												Short.MAX_VALUE)
										.addComponent(searchBt).addGap(34)))));
				...
				.addGroup(gl_panel.createSequentialGroup().addGap(15)
						.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE).addComponent(label)
								...
								.addComponent(label_2).addComponent(
										dateTxt, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_panel.createSequentialGroup().addGap(18).addComponent(searchBt)))
						.addContainerGap()));
		...
		levelBox.setModel(new DefaultComboBoxModel(
		...
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				...
				.addComponent(scrollPane, GroupLayout.DEFAULT_SIZE, 75, Short.MAX_VALUE).addGap(33)
				.addGroup(gl_contentPane
						.createParallelGroup(Alignment.BASELINE).addComponent(buyBt).addComponent(levelBox,
	...
	private void buyActionPerformed(ActionEvent evt) throws Exception {
		...
		System.out.println(resultTable.getValueAt(resultTable.getSelectedRow(), 6 +2 * level));
		int left =Integer.parseInt((String) resultTable.getValueAt(resultTable.getSelectedRow(), 6 +2 * level));
		if(left == 0) {
			int ans = JOptionPane.showConfirmDialog(this, "对不起，票已售完。请问是否排队抢票？");
			System.out.println("是否抢票："+ans);
			if(ans == 0) {
